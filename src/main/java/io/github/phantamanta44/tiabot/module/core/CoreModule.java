...
import io.github.phantamanta44.tiabot.module.core.command.CommandInvite;
...
import io.github.phantamanta44.tiabot.module.core.command.CommandUninvite;
...
public class CoreModule extends CTModule {
	...
	public CoreModule() {
		...
		commands.add(new CommandUninvite());
